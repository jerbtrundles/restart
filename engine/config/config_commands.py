# engine/config/config_commands.py
"""
Configuration for the command system, including aliases and prepositions.
"""

# --- Command Settings ---
QUEST_BOARD_ALIASES = ["board", "quest board", "notice board"]
